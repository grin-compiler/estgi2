...
export
liveSymbols : List (String, String, String)
liveSymbols =
...
export
liveQualifiedSymbols : List String
...
data Symbol
  ...
  | CmmFun  String
  | CmmData String
%runElab derive "Symbol" [Show, Eq, Ord]
